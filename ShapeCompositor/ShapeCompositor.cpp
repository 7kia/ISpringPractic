...
// ShapeCompositor.cpp : Определяет поведение классов для приложения.
//
...
// Единственный объект CShapeCompositorApp

CShapeCompositorApp theApp;


// инициализация CShapeCompositorApp
...
// обработчики сообщений CShapeCompositorApp
...
// CShapeCompositorApp настройка методов загрузки и сохранения
